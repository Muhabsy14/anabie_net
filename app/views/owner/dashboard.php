<div class="page-head">
  <div>
    ...
    <p class="sub">Ringkasan operasional <?= APP_NAME ?> hari ini.</p>
  </div>
</div>
...
<div class="stats">
  ...
  <div class="stat"><div class="si">🛡️</div><div><div class="sv"><?= $stats['total_admin'] ?></div><div class="sl">Akun Admin</div></div></div>
...
<div class="grid-2">
  <div class="card">
    ...
    <div class="flex gap wrap">
      <a class="btn btn-primary" href="<?= route('admin.index') ?>">🛡️ Kelola Admin</a>
      <a class="btn btn-outline" href="<?= route('pelanggan.index') ?>">👥 Pelanggan</a>
      <a class="btn btn-outline" href="<?= route('tagihan.index') ?>">🧾 Tagihan</a>
